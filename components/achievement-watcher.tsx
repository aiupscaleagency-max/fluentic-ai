    ...
    <AnimatePresence>
      {top && (
        <motion.div
          ...
          className="fixed top-20 right-4 z-[80] w-[300px] glass-strong border border-amber-300/40 rounded-2xl p-4 shadow-2xl shadow-amber-500/20 overflow-hidden"
        >
          <Confetti count={18} />
          <button
            type="button"
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <div className="text-xs uppercase tracking-wider text-amber-200 font-extrabold flex items-center gap-1">
                <Trophy className="h-3 w-3" /> {t("ach.unlocked")}
              </div>
